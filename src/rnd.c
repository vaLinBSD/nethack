 ...
 */
static int AES_SETUP(const unsigned char *key, int keylen, int num_rounds, symmetric_key *skey)
{
    int i, j;
    ulong32 temp, *rk;
    ulong32 *rrk;
...
#else
static int AES_encrypt(const unsigned char *pt, unsigned char *ct, symmetric_key *skey)
#endif
{
...
#ifdef LTC_CLEAN_STACK
static int ECB_ENC(const unsigned char *pt, unsigned char *ct, symmetric_key *skey)
{
...
#else
static int ECB_DEC(const unsigned char *ct, unsigned char *pt, symmetric_key *skey)
#endif
{
    ulong32 s0, s1, s2, s3, t0, t1, t2, t3, *rk;
    int Nr, r;
...
*/
static void ECB_DONE(symmetric_key *skey)
{
}
...
static void collect_entropy1(char* data)
{
	#ifdef UNIX
	#ifdef LINUX
...
static void collect_entropy2(char* data)
{
	struct timeval tv;
